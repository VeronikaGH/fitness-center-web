...
/*
<Row>
<Col className="col-3"><h6 className="mb-0">Date of Birth</h6></Col>
<Col className="col-9 text-secondary">1990/05/05</Col>
</Row>       
<Row>
<Col className="col-3"> <h6 class="mb-0">Address</h6> </Col>
<Col className="col-9 text-secondary">Vladimir, Russia </Col>
</Row>
*/